  ...
  return (
    <section className="border-t border-[var(--border-color)] relative flex items-center justify-between gap-4 px-4 sm:px-6 py-3.5">
      <div className="flex items-center gap-2">
        {socialLinks.map(({ href, icon: Icon, label }) => (
          <a
            ...
            title={label}
            className="flex items-center justify-center size-9 border border-[var(--border-color)] bg-[var(--icon-btn-bg)] rounded-md text-[var(--icon-btn-fg)] shadow-[var(--icon-btn-shadow)] hover:text-[var(--accent-color)] hover:border-[var(--accent-color)] transition-all duration-200"
          >
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center gap-2 px-4 py-2 text-xs font-mono text-[var(--icon-btn-fg)] border border-[var(--border-color)] bg-[var(--icon-btn-bg)] shadow-[var(--icon-btn-shadow)] hover:text-[var(--bg-color)] hover:bg-[var(--accent-color)] rounded-md transition-all duration-200 cursor-pointer"
      >
