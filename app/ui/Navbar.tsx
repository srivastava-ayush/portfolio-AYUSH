...
function Navbar() {
  ...
  const dockItems = [
    ...
    },
    {
      label: "Slices",
      href: "/slices",
      icon: <Image src={slices_logo} alt="Slices" width={20} height={20} />,
    },
  ];
      ...
      <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-[99998] md:hidden w-[90%] max-w-[400px] pb-[env(safe-area-inset-bottom,0px)]">
        ...
        >
          ...
          <div className="relative flex items-center justify-between px-3 py-2 backdrop-blur-2xl bg-[var(--bg-color)]/90 border border-[var(--border-color)]/40 rounded-lg shadow-[0_8px_32px_rgba(0,0,0,0.4),inset_0_1px_1px_rgba(255,255,255,0.05)]">
            ...
            <span className="w-px h-10 bg-[var(--border-color)]/80" />
            ...
            {/* Theme Toggle */}
            <div className="pl-2 border-l border-[var(--border-color)]/80">
              <ThemeToggleBtn
                theme={theme}
        ...
        {menuOpen && (
          ...
          >
            ...
            <div className="relative flex flex-col items-center justify-center h-full gap-8 px-6">
              ...
              >
                <Link
                  href="/https://srivastava-ayush.vercel.app/"
                  onClick={handleMenuToggle}
              ...
              {navItems.map((item, index) => (
                <motion.div
                  ...
                  className="border border-[var(--border-color)] p-1 w-[80%] bg-scanlines"
                >
                  <button
                    onClick={() => {
                      if (item.href.startsWith("#")) {
                    ...
                    className="flex  items-center gap-4 text-xl  font-medium font-serif  text-[var(--text-color)] hover:text-[var(--accent-color)] transition-colors"
                  >
              ...
              <motion.div
                ...
                className="mt-4 border border-[var(--border-color)] p-1"
              >
                <button
                  onClick={toggleTheme}
                  className="flex items-center gap-4 text-2xl font-medium text-[var(--secondary-text)] hover:text-[var(--text-color)] transition-colors"
                >
                  <span className="w-10 h-10 flex items-center justify-center rounded-xl bg-[var(--hover-color)]">
                    <svg
                      width="24"
