   ...
   ,
      {
        ...
        paras: [
          `Authorization - is the process of granting access to users
          for specific resources / actions / permissions, and Authorization checks for entry to specific room of house, It ask the question "we know you but do you have permission?"` ,

        ]
      },
      {
        heading: "What to look for Identification",
        paras: [
      ...
      {
        heading: "Passwords (shhhhhh)",
        paras: [`As we konw that in most of the applications we use passwords or pins to authenticate ourselfs, So it become extremly import to secure it`
        ]
      }
