...
const items = [
  { title: "Cascade", text: "Ideas flowing down like water, each drop carrying ripples of creative potential.", image: "/orangeBg.jpg" },
  { title: "Fusion", text: "Elements colliding and combining — the heat of creation forging something entirely new.", image: "/sliced_org.jpg" },
  { title: "Pulse", text: "The steady rhythm of progress, each beat marking another step toward the horizon.", image: "/multiBg.jpg" },
  { title: "Radiance", text: "Light emanating from within — the glow of inspiration that illuminates the path forward.", image: "/whiteBg.jpg" },
